...
@Slf4j
public class Hash5Thread extends Thread {

	private boolean flag = true;
	
	private boolean isFirst = true;
	
	private String MODE = "B3";
	private String KEY_1 = "HXBD5";
	private String KEY_2 = "HXNN5";
	private String MODE_1 = "4";
	private String MODE_2 = "7";
	@Override
	public void run() {
		while(flag) {
