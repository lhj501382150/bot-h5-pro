...
@Slf4j
public class Hash1Thread extends Thread {

	private boolean flag = true;
	
	private boolean isFirst = true;
	
	private String MODE = "B1";
	private String KEY_1 = "HXBD1";
	private String KEY_2 = "HXNN1";
	private String MODE_1 = "2";
	private String MODE_2 = "5";
	@Override
	public void run() {
		while(flag) {
