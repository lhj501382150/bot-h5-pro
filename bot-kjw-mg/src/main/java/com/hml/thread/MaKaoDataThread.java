...
@Slf4j
public class MaKaoDataThread extends Thread {
	...
	private String MODE = "C1";
	
	private Long DATA_ID = 0l;
	
	private Draw draw;
		
	public MaKaoDataThread() {
	...
	public void run() {
		while(flag) {
			try {
				drawService = (IDrawService)SpringUtil.getBean("drawService");
				String url ="https://cc.a6tk46.com/gallerynew/h5/index/lastLotteryRecord?lotteryType=2";
