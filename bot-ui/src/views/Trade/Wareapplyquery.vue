<template>
  <div class="page-container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      ...
      <el-form-item>
        <el-input v-model="filters.warename" placeholder="商品名称"></el-input>
			...
			<el-form-item>
				<kt-button icon="fa fa-search" :label="$t('action.search')" perms="trade:wareapply:list" type="primary" @click="findPage(null)"/>
			</el-form-item>
	...
	<kt-table :data="pageResult" :columns="filterColumns" :buttons="buttons"
		@findPage="findPage" @handleShow="handleShow" >
	</kt-table>
	<!--新增编辑界面-->
	<el-dialog title="查看" width="60%" :visible="true" v-if="dialogVisible" :close-on-click-modal="false" :show-close="false" :destroy-on-close="true"  v-dialogDrag>
...
export default {
	...
	methods: {
        ...
        this.pageRequest = {pageNum: 1, pageSize: 50}
			...
			this.$api.wareapply.findListPage(this.pageRequest).then((res) => {
...
statusFormat: function (row, column, cellValue, index){
  switch (cellValue) {
    ...
    initButtons(){
		  this.buttons=[
		   {icon:'fa fa-eye',label:'查看',perms:'trade:wareapply:list',type:'',callback:'handleShow'}
      ];
    }
	},
	mounted() {
