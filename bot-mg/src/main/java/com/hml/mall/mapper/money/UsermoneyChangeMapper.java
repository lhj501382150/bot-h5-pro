...
public interface UsermoneyChangeMapper extends BaseMapper<UsermoneyChange> {
	...
	@Select("select t.* from (select t1.*,t5.nickname,t2.username,t2.CLEVEL as clevel,t2.PARENTNO as parentno,t2.TJNO as tjno,t3.acctname,t4.subname,"
			...
			+ " from tb_zj_usermoney_change t1 left join TB_HY_USER_RELATION t2 on t1.USERNO = t2.USERNO "
	...
	@Insert("INSERT INTO tb_zj_his_usermoney_change SELECT * FROM tb_zj_usermoney_change WHERE fdate <= #{fdate} ")
